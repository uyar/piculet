...
class Extractor:
    ...
    def extract(
        self, element: Element, transform: Optional[bool] = ...
    ) -> Any: ...
    @staticmethod
...
def build_tree(document: str, lxml_html: Optional[bool] = ...) -> Element: ...
...
def scrape(
    document: str, spec: Mapping[str, Any], lxml_html: Optional[bool] = ...
) -> Mapping[str, Any]: ...
def h2x(source: str) -> None: ...
def scrape_document(
    address: str, spec: str, content_format: Optional[str] = ...
) -> None: ...
