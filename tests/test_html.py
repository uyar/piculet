...
def test_html_to_xhtml_skip_tags_should_be_removed():
    content = """<html><p></p><font></font></html>"""
    normalized = html_to_xhtml(content, skip_tags={"font"})
    assert normalized == """<html><p></p></html>"""


def test_html_to_xhtml_skip_attributes_should_be_removed():
    content = """<html><p font="times"></p></html>"""
    normalized = html_to_xhtml(content, skip_attrs={"font"})
    assert normalized == """<html><p></p></html>"""
